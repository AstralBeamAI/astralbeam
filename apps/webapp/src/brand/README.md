...
Edit `src/theme.json`, then run `vp run @astralbeam/webapp#generate:colors` and commit both the definition and checked-in stylesheet. Do not edit `colors.css` directly; Brand tests fail when it drifts from the JSON source.

...
- Generate and commit `src/colors.css` with `vp run @astralbeam/webapp#generate:colors`; do not edit the generated stylesheet directly. Brand tests fail when it drifts from `src/theme.json`.

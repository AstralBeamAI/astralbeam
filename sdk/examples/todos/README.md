...
3. Open http://localhost:3100. Toggle the sidebar with "Hide assistant", cycle "Assistant theme" through system/light/dark to retheme only the widget, press send to play the scripted conversation, and toggle the todo inside the chat to see host state update.

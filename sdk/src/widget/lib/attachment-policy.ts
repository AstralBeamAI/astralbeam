// Chat-chunk-only: the composer's attachment limits and the types the chat endpoint reads.
// Anything the eager client entry needs lives in src/lib/constants.ts instead.

// Chat-chunk-only: the named slots that project host content into the widget, and the CSS
// properties bridged onto them so a projected render reads in the host page's own style.

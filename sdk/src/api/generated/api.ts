 ...
 */
export const listTenants = (params: ListTenantsParams, options: Parameters<typeof astralBeamApiFetch>[1]) => {
 ...
 */
export const createTenant = (createTenantInput: CreateTenantInput, options: Parameters<typeof astralBeamApiFetch>[1]) => {
 ...
 */
export const updateTenant = (id: string,
    updateTenantInput: UpdateTenantInput, options: Parameters<typeof astralBeamApiFetch>[1]) => {
...
export const getListUsersForTenantUrl = (tenantId: string,
 ...
 */
export const listUsersForTenant = (tenantId: string,
    params: ListUsersForTenantParams, options: Parameters<typeof astralBeamApiFetch>[1]) => {
 ...
 */
export const createTenantUser = (tenantId: string,
    createTenantUserInput: CreateTenantUserInput, options: Parameters<typeof astralBeamApiFetch>[1]) => {
...
export const getGetTenantUserUrl = (tenantId: string,
    id: string,) => {
 ...
 */
export const getTenantUser = (tenantId: string,
    id: string, options: Parameters<typeof astralBeamApiFetch>[1]) => {
...
export const getUpdateTenantUserUrl = (tenantId: string,
    id: string,) => {
 ...
 */
export const updateTenantUser = (tenantId: string,
    id: string,
    updateTenantUserInput: UpdateTenantUserInput, options: Parameters<typeof astralBeamApiFetch>[1]) => {
 ...
 * @summary Run chat
 */
export const runChat = (chatRunInput: ChatRunInput, options: Parameters<typeof astralBeamChatFetch>[1]) => {
 ...
 */
export const getChatConfig = (params: GetChatConfigParams, options: Parameters<typeof astralBeamJwtFetch>[1]) => {
 ...
 */
export const getChatFile = (params: GetChatFileParams, options?: Parameters<typeof astralBeamFileFetch>[1]) => {

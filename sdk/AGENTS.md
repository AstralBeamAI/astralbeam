...
- Never edit `src/chat/styles.generated.ts`; regenerate it with `deno task generate:styles` (also run by `build`) after changing `src/styles.css` or any Tailwind classes, and commit it with the change.

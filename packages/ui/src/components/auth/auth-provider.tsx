...
// Local edits: Replaces the generated Sonner error bridge with Shadcn Base UI toast.
...
/**
 * Provides an authentication context by forwarding configuration and children to the Better Auth UI provider.
 *

// shadcn command: `vp run @astralbeam/ui#ui add field`
// Local edits: Removes a redundant group role and keys validation messages by their unique text for strict accessibility and React checks.

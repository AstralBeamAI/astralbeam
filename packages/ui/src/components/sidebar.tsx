// shadcn command: `vp run @astralbeam/ui#ui add sidebar`
// Local edits: Uses compiler-safe mobile state, avoids shadowed callbacks, and types custom CSS properties without assertions.

...
export const Route = createFileRoute("/_authenticated/$orgSlug/tenant-users/")({
  ...
  component: () => <OrganizationDirectory kind="tenant-users" />,
  head: () => ({ meta: [{ title: `Tenant users · ${APP_NAME}` }] }),
})

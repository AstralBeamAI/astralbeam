...
function completeStoredConfig() {
  const values: ConfigValues = {
    ...
    dogfood_api_key: `key_01990a5d-0000-7000-8000-000000000013_01990a5d-0000-7000-8000-000000000024_abo_${CONFIG_TEST_SECRET}`,
...
describe("global configuration", () => {
  ...
  test("unreadable secrets keep only their required or selected features incomplete", async () => {
    ...
    setStoredConfig({
      ...complete,
      rows: [...(complete.rows ?? []), { key: "resend_api_key", storageStatus: "unreadable" }],
    })

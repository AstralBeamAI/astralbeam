...
- Derive test JWT permissions from seeded user identities. Select explicit admin or non-admin fixtures instead of overriding their roles with boolean arguments.

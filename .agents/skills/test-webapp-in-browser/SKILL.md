...
4. Reset only an explicitly authorized, confirmed-disposable database using `webapp/src/db/README.md`. Because worktrees can share services, prefer a task-specific database and unique test identities when state changes unexpectedly. do not clear the shared Mailpit inbox.

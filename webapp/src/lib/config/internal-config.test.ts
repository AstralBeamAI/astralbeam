...
test("internal values cannot be overridden or edited through generic configuration", async () => {
  for (const key of ["internal_organization_id", "internal_pending_setup"]) {

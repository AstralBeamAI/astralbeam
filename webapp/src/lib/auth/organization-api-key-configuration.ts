...
export const ORGANIZATION_API_KEY_RATE_LIMIT_DESCRIPTION =
  `Raw-key limit: ${ORGANIZATION_API_KEY_RATE_LIMIT_MAX_REQUESTS} requests per ${ORGANIZATION_API_KEY_RATE_LIMIT_WINDOW_MINUTES} minutes; creating or verifying chat tokens does not consume it or update Last request.`

...
import { CURRENT_TERMS_VERSION, PRIVACY_POLICY_URL, TERMS_OF_SERVICE_URL } from "@/auth/terms"
        ...
        <div className="flex flex-col gap-6">
          {!emailAndPassword?.enabled && (
            <Field orientation="horizontal">
              ...
              />
              <FieldLabel className="block font-normal leading-relaxed" htmlFor="terms-accepted">
                I accept the{" "}
                <a
                ...
                <span className="sr-only">version {CURRENT_TERMS_VERSION}</span>
              </FieldLabel>
            </Field>
          )}
          {socialPosition === "top" && (
            <>
              {socialProviders && socialProviders.length > 0 && (
                <ProviderButtons
                  disabled={!emailAndPassword?.enabled && !termsAccepted}

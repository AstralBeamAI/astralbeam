...
import { AddOrganizationAccessDialog } from "./add-organization-access-dialog"
...
export function OrganizationMembers({
  ...
  const canManageAccess = isOwner || hasMemberRole(activeMemberRole?.role, "admin")
              ...
              {isPending ? <OrganizationMemberRowSkeleton /> : (
                ...
                sortedMembers?.map((member) => (
                  <OrganizationMemberRow
                    ...
                    member={member}
                    isOwner={isOwner}
                    isSoleOwner={isSoleOwner && member.userId === session?.user.id}

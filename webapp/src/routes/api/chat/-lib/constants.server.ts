...
export const AUTH_TOKEN_AUDIENCE = APP_HANDLE
export const AUTH_TOKEN_TYPE = `${APP_HANDLE}+jwt`
export const AUTH_TOKEN_MIN_LIFETIME_SECONDS = 60
export const AUTH_TOKEN_MAX_LIFETIME_SECONDS = 600
export const AUTH_TOKEN_MAX_LENGTH = 16_384
export const AUTH_TOKEN_IDENTITY_MAX_BYTES = 8 * 1024

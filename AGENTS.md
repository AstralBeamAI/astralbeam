...
- Run recursive auto-fixes serially with `vp run -r --concurrency-limit 1 check:fix`; the root and brand fixers can otherwise write the same files concurrently.
